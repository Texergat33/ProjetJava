...
public class BoulderDashControllerTest {
    ...
    // @Test
    /*
     * public void testPlay() { final BoulderDashController controller = new
     * BoulderDashController(null, null); final Miner miner = new Miner(2, 2,
     * SpriteFactory.createMiner("MinerRight1"), new Map(1),
     * Permeability.KILLABLE); miner.die(); assertEquals(controller.play(),
     * controller.getView().displayMessage("Game over")); }
     */
